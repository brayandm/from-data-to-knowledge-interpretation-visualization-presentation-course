...
ggsave("facet_donut_plot.png", width = 15, height = 8)
```
...
ggsave("faceted_lollipop_plot.png", plot, width = 15, height = 10)
print(plot)
```
...
plot <- ggplot(long_df, aes(x = T1, y = Value, color = Household_Size)) +
  geom_point() +
  geom_smooth(se = FALSE) +
  facet_wrap(~ C4) +
  labs(x = "Time (T1)", y = "Value of Indicators (HS01:HS11)", 
       title = "Smoothed Dot Plot of Household Size Indicators Over Time") +
  theme_minimal()

ggsave("smoothed_dot_plot.png", plot, width = 15, height = 10)
