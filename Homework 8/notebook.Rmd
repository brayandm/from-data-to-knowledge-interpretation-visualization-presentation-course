...
MAP4 <- ggplot() +
  ...
  geom_text(data = as.data.frame(labels), aes(x = st_coordinates(labels)[,1], y = st_coordinates(labels)[,2], label = NOMBRE), 
            size = 3, color = "black", fill = "white", label.size = NA, inherit.aes = FALSE) +
