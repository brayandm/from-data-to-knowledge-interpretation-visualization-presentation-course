...
data_filtered$deaths_category <- factor(data_filtered$deaths_category, levels = c("1-10", "11-50", "51-100", "101-200", ">200"))
...
plot <- ggplot() +
  ...
  geom_sf(data = data_sf, aes(size = deaths_category), color = "red", alpha = 0.7) +
  scale_size_manual(values = c("1-10" = 1, "11-50" = 3, "51-100" = 5, "101-200" = 7, ">200" = 10), name = "Number of Deaths") +
  theme_minimal() +
