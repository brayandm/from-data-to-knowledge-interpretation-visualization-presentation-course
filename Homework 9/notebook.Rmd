...
BCN_TILE <- get_stadiamap(bbox = bbox_fixed, zoom = 14, maptype = "stamen_toner_lite", crop = TRUE, messaging = FALSE)
...
combined_map <- marrangeGrob(map_list, ncol = 1, nrow = 3)

print(combined_map)

ggsave("routes_combined.png", plot = combined_map, scale = 1, height = 36, width = 12, dpi = 300)
```